...
static int cmd_zvm_run(const struct shell *shell, size_t argc, char **argv){
    ...
    shell_fprintf(shell, SHELL_NORMAL, "Run vm success.\n");
    return 0;
}
...
static int cmd_zvm_update(const struct shell *shell, size_t argc, char **argv){
    ...
    shell_fprintf(shell, SHELL_NORMAL, "Update vm success.\n");
    return 0;
}
...
static int cmd_zvm_list(const struct shell *shell, size_t argc, char **argv){
    ...
    shell_fprintf(shell, SHELL_NORMAL, "List vm success.\n");
    return 0;
}
...
static int cmd_zvm_pause(const struct shell *shell, size_t argc, char **argv){
    ...
    shell_fprintf(shell, SHELL_NORMAL, "Pause vm success.\n");
    return 0;
}
...
static int cmd_zvm_halt(const struct shell *shell, size_t argc, char **argv){
    ...
    shell_fprintf(shell, SHELL_NORMAL, "Halt vm success.\n");
    return 0;
}
...
static int cmd_zvm_delete(const struct shell *shell, size_t argc, char **argv){
    ...
    shell_fprintf(shell, SHELL_NORMAL, "Delete vm success.\n");
    return 0;
}
